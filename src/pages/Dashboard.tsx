  ...
  return (
    <div className="min-h-screen w-full max-w-5xl mx-auto p-6 space-y-6">
      <header className="flex items-center justify-between">
        ...
        <button onClick={handleLogout} className="rounded-xl px-4 py-2 border hover:bg-gray-50">
          Logout
        </button>
      </header>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="border rounded-2xl p-4">
          ...
          <div className="flex gap-3 flex-wrap">
            <Link to="/standings" className="underline underline-offset-4">NFL Standings</Link>
            <Link to="/schedule" className="underline underline-offset-4">NFL Schedule</Link>
          </div>
        </div>
